        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-2 bottom-border" style="font-size: 9px;"><?php echo $_SESSION['EMP_Dname'];?></a>
              <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-2 bottom-border" style="text-align: center;font-size: 12px;font-weight:bolder;"><?php echo $_SESSION['EMP_Uname'];?></a>
