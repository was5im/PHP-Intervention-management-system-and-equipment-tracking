...
?>
 ...
 <?php
   $id= $_SESSION['EMP_id'];
   $query = "SELECT id,objet,descreption,date,pdf FROM intervention WHERE D_id='$id'";
          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-12 col-12 mb-4 mb-xl-0">
                ...
                <table class="table table-dark table-hover text-center">
                  ...
                  <?php
                     ...
                     <?php
                         ...
                         echo '<div class="alert alert-danger col" role="alert"> Aucune intervention trouvée </div>';
                         }
                     ?>   
                ...
                <!-- end of pagination -->
                <button type="submit" class="btn btn-secondary btn-block"><a href="ajouter_intervention.php"><span class="fa fa-plus-circle mr-3 "></span>Ajouter une intervention</a></button>                
              </div>
            </div>
          </div>
        </div>
