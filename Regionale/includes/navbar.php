        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-2 bottom-border" style="font-size: 9px;"><?php echo $_SESSION['COR_Dname']; ?></a>
              <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-2 bottom-border" style="text-align: center;font-size: 12px;font-weight:bolder;"><?php echo $_SESSION['COR_Uname']; ?></a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" href="../../Login/login.php" class="btn btn-success" data-dismiss="modal">Deconnexion</button>
