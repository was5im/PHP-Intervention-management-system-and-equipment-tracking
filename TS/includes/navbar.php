        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-2 bottom-border" style="font-size: 9px;"><?php echo $_SESSION['TS_Dname']; ?></a>
              <a href="#" class="navbar-brand text-white d-block mx-auto text-center py-3 mb-2 bottom-border" style="text-align: center;font-size: 12px;font-weight:bolder;"><?php echo $_SESSION['TS_Uname']; ?></a>
            
            <ul class="navbar-nav flex-column mt-4">
              <li class="nav-item"><a href="indexTS.php" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-fw fa-tachometer-alt text-light fa-lg mr-3"></i>Tableau de Bord</a></li>
              ...
              <div class="row align-items-center">
                ...
                <ul class="navbar-nav">
                    ...
                    <?php
                          ...
                          $query = "SELECT id_inter FROM intervention WHERE id_inter='0'";  
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-success" data-dismiss="modal">Deconnexion</button>
