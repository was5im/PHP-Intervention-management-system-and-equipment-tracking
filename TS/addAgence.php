       ...
       <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
         <div class="card cardColor">
           ...
           <div class="form-group">
              <label >ID Agence<sup>*</sup></label>
              <input type="text" class="form-control" name="D_id" id="D_id" placeholder="Entrez id direction...">
            </div>
            <div class="form-group">
                <label >ID direction regionale<sup>*</sup></label>
                <input type="text" class="form-control" name="DR_id" id="DR_id" placeholder="Entrez le nom de la direction regionale...">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label >Nom d'agence<sup>*</sup></label>
            ...
            <button type="submit" class="btn btn-success" name="valider3">Valider</button>
...
<script type="text/javascript">
    document.getElementById("form_msg").onsubmit = function(e)
    {
        ...
        else if(document.getElementById("DR_id").value == "")
        {
            e.preventDefault();
            document.getElementById("err").innerHTML = '<div class="alert alert-danger col" role="alert"> Veuillez remplir le champs ID Direction Regionale </div>';
        ...
        {
            e.preventDefault();
            document.getElementById("err").innerHTML = '<div class="alert alert-danger col" role="alert"> Veuillez remplir le champs Nom d\'agence </div>';
