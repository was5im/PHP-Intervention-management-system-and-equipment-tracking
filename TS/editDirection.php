         ...
         <div class="card cardColor">
           ...
           <form action="code.php" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="edit_Uid" value="<?php echo $row['user_id']; ?>" placeholder="Entrez le nom de la direction...">
            </div>
            <div class="form-group">
              <label >Nom de direction<sup>*</sup></label>
              <input type="text" class="form-control" name="edit_Dname" value="<?php echo $row['name']; ?>" placeholder="Entrez le nom de la direction...">
            </div>
            <div class="form-group">
              <label >Nom d'utilisateur<sup>*</sup></label>
              <input type="text" class="form-control" name="edit_Uname" value="<?php echo $row['username']; ?>" placeholder="Entrez le nom d'utilisateur...">
            </div>
            <div class="form-group">
                <label >Code<sup>*</sup></label>
                <input type="text" class="form-control" name="edit_code" value="<?php echo $row['code']; ?>" placeholder="Entrez votre code...">
            </div>
